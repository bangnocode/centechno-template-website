...
<body class="scroll-smooth">
    ...
    <div id="home"
        class="h-screen w-full flex items-center justify-center bg-[url(/img/background.webp)] text-white bg-no-repeat bg-cover bg-center">
        <div class="container-banner text-center">
            ...
            <h2 class="text-base font-medium mx-12 mb-16 md:text-xl md:mx-16 xl:mx-64 lg:mx-32 text-gray-200">Kami
                membantu UMKM dan perusahaan membangun identitas visual yang kuat — dari logo, website hingga konten
                media sosial yang menarik pelanggan.</h2>
            <div class="flex justify-center">
                <a href="#layanan-kami"
                    ...
                    Layanan <svg class="w-5 h-5 animate-bounce" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
    ...
    <div class="p-10 sm:px-24 md:px-24 xl:px-52 bg-gray-50">
        ...
        <h2 class="text-center font-medium text-base mb-10 md:text-xl text-gray-600">Layanan profesional yang kami
            tawarkan untuk meningkatkan identitas dan penjualan bisnis Anda</h2>
        <div class="grid gap-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">

            <div class="card-product bg-white border-yellow-400 border-2 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 pb-8"
                ...
                <div class="container-detail-product px-8 text-lg font-medium rounded-b-lg">
                    ...
                    <p class="flex items-center gap-2 mb-3 text-base leading-none">
                        <span
                            class="inline-flex items-center justify-center w-5 h-5 bg-green-500 rounded-full flex-shrink-0">
                            <svg class="w-3 h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M5 13l4 4L19 7"></path>
                            </svg>
                        </span>
                        3 konsep logo awal (pilih satu yang disempurnakan)
                    </p>
                    ...
                    <p class="flex items-center gap-2 mb-3 text-base leading-none">
                        ...
                        2x revisi final & delivery file vector (AI, SVG, PDF)
                    </p>
                    ...
                    <p class="flex items-center gap-2 mb-3 text-base leading-none">
                        ...
                        Logo versi warna & monokrom + favicon
                    </p>
                    ...
                    <p class="flex items-center gap-2 mb-3 text-base leading-none">
                        ...
                        </span>Brand guideline singkat (warna & tipografi)
                    </p>
                </div>
            ...
            <div class="card-product bg-white border-green-400 border-2 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 pb-8"
                data-aos="fade-up" data-aos-offset="25">
                <div
                    class="container-name-product bg-gradient-to-r from-blue-600 to-blue-800 px-8 py-6 rounded-t-lg text-center text-black">
                ...
                <div class="container-detail-product px-8 text-lg font-medium rounded-b-lg">
                    ...
                    <p class="flex items-center gap-2 mb-3 text-base leading-none">
                        ...
                        </span>Desain responsif 1 halaman (single page) atau landing page
                    </p>
                    ...
                    <p class="flex items-center gap-2 mb-3 text-base leading-none">
                        ...
                        </span>Integrasi kontak & formulir WhatsApp / email
                    </p>
                    ...
                    <p class="flex items-center gap-2 mb-3 text-base leading-none">
                        ...
                        </span>Optimasi SEO dasar & kecepatan (performance)
                    </p>
                    ...
                    <p class="flex items-center gap-2 mb-3 text-base leading-none">
                        ...
                        </span>1 tahun hosting & domain .my.id (opsional paket)
                    </p>
                </div>
                <div class="btn-contact-admin flex justify-center mt-12">
                    <a href="#kontak"
            ...
            <div class="card-product bg-white border-blue-400 border-2 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 pb-8"
                data-aos="fade-up" data-aos-offset="25">
                <div
                    class="container-name-product bg-gradient-to-r from-blue-600 to-blue-800 px-8 py-6 rounded-t-lg text-center text-black">
                ...
                <div class="container-detail-product px-8 text-lg font-medium rounded-b-lg">
                    ...
                    <p class="flex items-center gap-2 mb-3 text-base leading-none">
                        ...
                        </span>Template post & story (5 desain per paket)
                    </p>
                    ...
                    <p class="flex items-center gap-2 mb-3 text-base leading-none">
                        ...
                        </span>Copywriting singkat & call-to-action
                    </p>
                    ...
                    <p class="flex items-center gap-2 mb-3 text-base leading-none">
                        ...
                        </span>Format siap unggah (PNG / MP4 / Canva link)
                    </p>
                    ...
                    <p class="flex items-center gap-2 mb-3 text-base leading-none">
                        ...
                        </span>Strategi caption & hashtag untuk jangkauan
                    </p>
                </div>
                <div class="btn-contact-admin flex justify-center mt-12">
                    <a href="#kontak"
    ...
    <div class="px-12 py-20 bg-blue-800 bg-no-repeat bg-cover bg-right md:px-28">
        ...
        <div class="container-about-us text-white grid grid-cols-1 items-center justify-center gap-16 lg:grid-cols-2">
            <div data-aos="fade-right" data-aos-offset="25" class="text-base md:text-lg">
                <p><span class="font-bold text-yellow-400">Centechno</span> adalah studio desain yang fokus membantu
                    usaha kecil, UMKM, dan brand lokal tumbuh melalui identitas visual yang kuat dan solusi digital
                    praktis. Kami menggabungkan estetika desain dengan tujuan pemasaran untuk menghasilkan aset yang
                    bukan hanya cantik, tapi juga mendatangkan pelanggan.</p>
                <p class="mt-4">Tim kami terdiri dari desainer, developer, dan content creator yang berpengalaman —
                    siap mendampingi dari konsep hingga publikasi.</p>
            </div>
    ...
    <div class="p-10 pt-20">
        ...
        <h2 class="font-medium text-base mb-10 text-center md:text-xl md:px-32 text-gray-600">Testimoni klien yang
            sudah menggunakan layanan kami</h2>
            ...
            <div class="review-1 bg-white shadow-lg hover:shadow-xl transition-shadow rounded-lg p-5 items-center"
                ...
                <div class="mb-4">
                    <h1 class="font-medium text-base text-gray-700">
                        "Hasil logo sangat profesional dan sesuai brief. Proses cepat, komunikasi mudah, dan revisi
                        ditangani rapi."
                    </h1>
                </div>
                <div class="flex gap-1">
                    ...
                    <div class="">
                        ...
                        <div class="bintang-rating flex">
                            <svg class="w-4 h-4 text-yellow-400 ms-1" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
                                <path
                                    d="M20.924 7.625a1.523 1.523 0 0 0-1.238-1.044l-5.051-.734-2.259-4.577a1.534 1.534 0 0 0-2.752 0L7.365 5.847l-5.051.734A1.535 1.535 0 0 0 1.463 9.2l3.656 3.563-.863 5.031a1.532 1.532 0 0 0 2.226 1.616L11 17.033l4.518 2.375a1.534 1.534 0 0 0 2.226-1.617l-.863-5.03L20.537 9.2a1.523 1.523 0 0 0 .387-1.575Z" />
                            </svg>
                            <!-- repeat 4 more -->
                            <svg class="w-4 h-4 text-yellow-400 ms-1" fill="currentColor" viewBox="0 0 22 20">
                                <path
                                    d="M20.924 7.625a1.523 1.523 0 0 0-1.238-1.044l-5.051-.734-2.259-4.577a1.534 1.534 0 0 0-2.752 0L7.365 5.847l-5.051.734A1.535 1.535 0 0 0 1.463 9.2l3.656 3.563-.863 5.031a1.532 1.532 0 0 0 2.226 1.616L11 17.033l4.518 2.375a1.534 1.534 0 0 0 2.226-1.617l-.863-5.03L20.537 9.2a1.523 1.523 0 0 0 .387-1.575Z" />
                            </svg>
                            <svg class="w-4 h-4 text-yellow-400 ms-1" fill="currentColor" viewBox="0 0 22 20">
    ...
    <div class="px-10 py-20 md:px-32 lg:px-44 xl:px-64" id="kontak">
        <div class="appear-bottom-to-top">
            ...
            <h1 class="text-base text-center font-medium mb-8 md:text-xl text-gray-600">Hubungi admin kami lewat salah
                satu kontak di bawah — cepat & ramah.</h1>
            ...
            <a href="https://wa.me/6281234567890" class="rounded-3xl" data-aos="fade-left" data-aos-offset="25">
                <div
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                        class="w-5 h-5 text-green-600 bi bi-whatsapp" viewBox="0 0 16 16">
                        <path
    ...
    <div class="p-10 bg-blue-900 text-center flex flex-col items-center">
        <h1 class="mb-1 text-lg font-bold text-white md:text-xl flex items-center gap-2"><img
                src="{{ asset('img/logo-ct.png') }}" class="w-12" alt="logo">CENTECHNO</h1>
