...
<body class="scroll-smooth">
    ...
    <div id="home"
        class="h-screen w-full flex items-center justify-center bg-[url({{asset('img/background.webp')}})] text-white bg-no-repeat bg-cover bg-center">
    ...
    <div class="p-10 bg-blue-900 text-center flex flex-col items-center">
        <h1 class="mb-1 text-lg font-bold text-white md:text-xl flex items-center gap-2"><img src="./img/logo.png"
                class="w-12" alt="logo">CENTECHNO</h1>
